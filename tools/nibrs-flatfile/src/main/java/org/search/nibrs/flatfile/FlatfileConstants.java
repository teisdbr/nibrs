...
public interface FlatfileConstants {
    ...
    public static final int OFFENSE_SINGLE_BIAS_SEGMENT_LENGTH = 63;
    public static final int OFFENSE_MULTIPLE_BIAS_SEGMENT_LENGTH = 71;
	public static final int OFFENDER_WITHOUT_ETHNICITY_SEGMENT_LENGTH = 45;
