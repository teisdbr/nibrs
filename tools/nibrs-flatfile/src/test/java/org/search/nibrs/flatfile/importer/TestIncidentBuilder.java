...
public class TestIncidentBuilder
{
    ...
    private static final String TESTDATA =
        ...
        "00455I022003    TN006000002-018065   0100  FWN\n" +
        ...
        "00455I022003    TN006000002-023736   0121  MWH\n" +
        ...
        "00632I022003    TN038010003000037    290CN  20               6162      \n" +
        "03073I022003    TN038010003000037    720000000150                                                                                                                                                                                                                                                                  \n" +
        "03073I022003    TN038010003000037    432000000100                                                                                                                                                                                                                                                                  \n" +
        "01294I022003    TN038010003000037    00113A23H290                     L20  FBNR09   N    01BG                                    01G         \n" +
    ...
    {
        testdataReader = new BufferedReader(new StringReader(TESTDATA));
        ...
        incidentBuilder.buildIncidents(testdataReader);
        //System.out.println(incidentListener.getThrowablesMap());
    }
