...
ALTER TABLE OffenseSegment ADD CONSTRAINT BiasMotivationType_OffenseSegment_fk FOREIGN KEY (BiasMotivationTypeID) REFERENCES BiasMotivationType (BiasMotivationTypeID);
